    ...
    return {
        ...
        compile: function(elm, attr) {
            ...
            attr.$set('jqmClass',
                ...
                "'ui-btn-left': $scopeAs.jqmBtn.isBtnPosLeft(),"+
                "'ui-btn-right': $scopeAs.jqmBtn.isBtnPosRight()}"
            );
            ...
            return function(scope, elm, attr, controlGroup) {
                ...
                scope.isBtnPosLeft = isBtnPosLeft;
                scope.isBtnPosRight = isBtnPosRight;
                ...
                function isBtnPosLeft() {
                    return scope.buttonpos && scope.buttonpos == 'left' ;
                }
                function isBtnPosRight() {
                    return scope.buttonpos && scope.buttonpos == 'right' ;
                }
...
jqmModule.directive('jqmListview', ['$rootScope', function($rootScope) {
    ...
    return {
        ...
        link: function(scope, element, attr, iscrollCtrl) {
            ...
            console.info('jqmListview directive', element[0])

            $rootScope.$on('LastElem', function(event){
                if( iscrollCtrl && iscroll ){
                    iscroll = false;
                    console.log(iscrollCtrl);
                    setTimeout(function() {
        ...
        link: function (scope, element, attr, ngModelCtrl) {
            ...
            function linkInput() {
                ...
                textarea
                    ...
                    .bind('keydown', function (e, i) {
                        if(e.keyCode == 13){
                            textarea.css('height', textarea[0].offsetHeight + lineHeight);
                        }
                    })
                    .bind('keyup', function (e) {
                        if(textarea[0].scrollHeight > h){
                            textarea.css('height', textarea[0].offsetHeight + lineHeight);
                        }
                    });
...
angular.module("templates/jqmButton.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/jqmButton.html",
    ...
    "  <span ng-if=\"$scopeAs.jqmBtn.icon\" class=\"ui-icon {{$parent.icon}}\" class=\"{'ui-icon-shadow':$parent.shadow}\">&nbsp;</span>\n" +
    "</span>\n" +
    "");
}]);
